# -*- coding: utf-8 -*-
#
# Théorie Relative documentation build configuration file, created by
# sphinx-quickstart on Thu Feb 28 10:39:22 2013.
#
...
project = u'Théorie Relative de la Monnaie'
copyright = u'Stéphane Laborde'
...
html_title = u"Théorie Relative de la Monnaie v2.718"
...
htmlhelp_basename = 'ThorieRelativedoc'
...
latex_documents = [
  ('index', 'TheorieRelativedelaMonnaie.tex', u'Théorie Relative de la Monnaie v2.718',
...
man_pages = [
    ('index', 'thorierelative', u'Théorie Relative',
     [u'de la MonnaieStéphane Laborde'], 1)
]
...
texinfo_documents = [
  ('index', 'ThorieRelative', u'Théorie Relative',
   u'de la MonnaieStéphane Laborde', 'ThorieRelative', 'One line description of project.',
   'Miscellaneous'),
]
